...
function FloatingCard({ className, children }: { className?: string; children: React.ReactNode }) {
    return (
        <div className={`absolute ${className}`}>
            {/* Orange logo badge */}
            <div className="absolute -top-[53px] left-4 z-10 flex size-[72px] items-center justify-center overflow-hidden rounded-full border-8 border-brand-soft bg-orange">
        ...
        <div className="flex items-end gap-[6px] h-[80px]">
            {bars.map((h, i) => (
                <div
                    ...
                    style={{
                        height: `${h}%`,
                        backgroundColor: i === 3 ? "var(--brand)" : "var(--border)",
                    }}
                />
            ))}
        </div>
...
function MiniDonutChart() {
    return (
        <div className="relative flex items-center justify-center size-[74px]">
            ...
            <span className="absolute text-[11px] font-bold text-ink">25%</span>
        </div>
    );
}
...
export function LoginDecorativePanel() {
    return (
        <div className="relative flex-1 items-center justify-center overflow-hidden bg-brand-soft max-lg:hidden lg:flex">
            ...
            <FloatingCard className="left-[60px] top-[120px] w-[222px]">
                <div className="px-6 py-5">
                    <p className="text-[16px] font-bold uppercase leading-none text-ink">
                        Profitability
                    </p>
                    <p className="mt-1 text-[16px] font-bold uppercase leading-none text-ink">
                        $2,222.65
                    </p>
                    <div className="mt-3">
                        <MiniBarChart />
            ...
            <FloatingCard className="right-[40px] top-1/2 w-[277px] -translate-y-1/2">
                <div className="px-6 pb-5 pt-6">
                    ...
                    <div className="mt-3 flex items-end gap-2">
                        <span className="text-[16px] font-bold uppercase leading-none text-orange">
                            +5.6%
                        </span>
            ...
            <FloatingCard className="bottom-[80px] left-[100px] w-[240px]">
                <div className="px-6 pb-5 pt-7">
                    <p className="text-[25px] font-bold uppercase leading-none tracking-[-0.75px] text-ink">
                        marketing digital
                    </p>
